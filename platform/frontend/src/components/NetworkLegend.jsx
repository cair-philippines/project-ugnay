  ...
  return (
    <div className="absolute bottom-3 left-3 z-20 flex flex-col justify-end pointer-events-none">
      ...
      <div className="w-[310px] bg-white/95 backdrop-blur shadow rounded-lg overflow-hidden">
        ...
        >
          <div className="px-3 pb-2.5 pt-2 border-t border-gray-100 text-xs pointer-events-auto overflow-y-auto max-h-[calc(100vh-13rem)]">
            <p className="text-[11px] leading-relaxed text-gray-600">
              Position is <span className="font-medium text-gray-800">structure, not place</span>.
              Institutions are pulled together by the pathways between them, so one whose
              pathway goes nowhere has nothing holding it in — it drifts to the edge.
            </p>
            ...
            <div className="mt-3 pt-3 border-t border-gray-200">
              ...
              <div className="space-y-1 text-gray-700">
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <span>
                    <span className="font-medium">Dead-end chain</span> — there IS a next step,
                    but nothing downstream ever reaches {PATHWAYS[pathway].ends}.{" "}
            ...
            <div className="mt-3 pt-3 border-t border-gray-200">
              ...
              <p className="mt-1 text-[10px] leading-relaxed text-gray-500">
                ...
                <span className="font-medium text-gray-700">never complete a pathway</span>.
                A chain that could double back through a university would call almost
                everything complete.
              </p>
            </div>
            ...
            <div className="mt-3 pt-3 border-t border-gray-200">
              ...
              <div className="border-l-2 border-slate-300 pl-2.5 space-y-1.5 text-[11px] leading-relaxed text-gray-500">
                <p>
                  A chain is a sequence of <span className="font-medium text-gray-700">local
                  moves</span>, each within {thresholdKm} km — not one commute. Four hops can
                  still add up to a long way from home.
                </p>
                <p>
                  ...
                  <span className="font-medium text-gray-700">lines</span> can only be drawn
                  between institutions you have actually loaded — a node near the edge of your
                  selection may have neighbours off-screen.
                </p>
                <p>
                  TESDA matching is <span className="font-medium text-gray-700">role-based
                  only</span> — it does not check that the assessment centre assesses the
                  qualification trained for, so tech-voc completeness is{" "}
